...
public class OtpVerifyActivity extends AppCompatActivity {
    TextView tv_forgot_text,tv_text,tv_back_to,tv_submit,tv_not_receive;
    EditText et_mobile;
    @Override
    ...
    private void function() {
      ...
      //  tv_text.setTypeface(regular);
        ...
        tv_not_receive.setTypeface(regular);

        tv_submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OtpVerifyActivity.this, SetPasswordActivity.class);
