...
public class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.ViewHolder> {
    ...
    public AddressAdapter(Context c,  ArrayList<HashMap<String, String>> address_list,
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
         ...
         String address= address_list.get(position).get("address");
         String postal_code= address_list.get(position).get("postal_code");
         String add_lat= address_list.get(position).get("add_lat");
         String add_long= address_list.get(position).get("add_long");
         holder.tv_address_1.setText(name+", "+phone);
         holder.tv_address_2.setText(address+", "+postal_code);
